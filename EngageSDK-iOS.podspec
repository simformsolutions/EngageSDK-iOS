#
#  Be sure to run `pod spec lint EngageSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "EngageSDK provide the becacon searching and also provode searching based on location"
                   

  spec.homepage     = "https://www.proximipro.com"
  ...
  #spec.exclude_files = "Classes/Exclude"
    spec.public_header_files = "EngageSDKFrameworks/Frameworks/EngageSDK.framework/Headers/*.h"
    spec.source_files = "EngageSDKFrameworks/Frameworks/EngageSDK.framework/Headers/*.h"
