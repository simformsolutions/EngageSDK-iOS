...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EngageSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9EngageSDK11ContentView")
...
/// EngageSDK
SWIFT_CLASS("_TtC9EngageSDK9EngageSDK")
...
@interface EngageSDK (SWIFT_EXTENSION(EngageSDK)) <CBPeripheralManagerDelegate>
...
@interface EngageSDK (SWIFT_EXTENSION(EngageSDK))
/// updateBeaconUUID: Update beacon UUID
/// \param uuid beacon UUID
///
/// \param callBack sucess/failure
///
- (void)updateBeaconUUIDWithUuid:(NSString * _Nonnull)uuid callBack:(void (^ _Nonnull)(BOOL))callBack;
...
/// \param callBack sucess/failure
///
- (void)setRegionParams:(NSString * _Nonnull)uuid regionId:(NSString * _Nonnull)regionId callBack:(void (^ _Nonnull)(BOOL))callBack;
/// updateApiKey: Update Api key
/// \param apiKey apiKey to updated
///
/// \param callBack sucess/failure
///
- (void)updateApiKey:(NSString * _Nonnull)apiKey callBack:(void (^ _Nonnull)(BOOL))callBack;
@end
...
@interface EngageSDK (SWIFT_EXTENSION(EngageSDK)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC9EngageSDK21InitializationRequest")
@interface InitializationRequest : NSObject
- (nonnull instancetype)initWithApiKey:(NSString * _Nonnull)apiKey appName:(NSString * _Nonnull)appName regionId:(NSString * _Nonnull)regionId clientId:(NSString * _Nonnull)clientId uuid:(NSString * _Nonnull)uuid OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC9EngageSDK17ListTableViewCell")
